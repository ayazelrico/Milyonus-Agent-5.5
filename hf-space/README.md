---
title: Milyonus Verified Memory
emoji: ✦
colorFrom: blue
colorTo: indigo
sdk: gradio
...
pinned: true
license: apache-2.0
short_description: Poison-proof agent memory — try to poison it, watch it get blocked.
---
...
Runs the deterministic rule-based verifier (no LLM, no cost). PoisonBench: **0%
attack success** vs a published 66.67% for flexible-write memory.
